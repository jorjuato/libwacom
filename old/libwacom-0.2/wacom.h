...
// 		WACOM_SCANMODE_UNBLOCK: Cada evento produce una llamada a la funcion callback
//		WACOM_SCANMODE_SIGNAL:  Los eventos no generan retrollamadas.

typedef enum {
	WACOM_SCANMODE_UNBLOCK,
	WACOM_SCANMODE_POLL,
	WACOM_SCANMODE_MAX
} WACOM_SCANMODE;

#define GAP_WACOM	3000	// Sampling rate in microseconds
